...
FIT = LabelDict({"linewidth": 2, "label": "fit"})  # "color": colors[1],
GUESS = LabelDict(
    {"linewidth": 2, "label": "guess", "alpha": 0.6}
)  # "color": colors[2],
...
# TWO_TONE = LabelDict(
#     {"xlabel": BIAS_VOLTAGE, "ylabel": DRIVE_FREQ}, GHz={"ylabel": DRIVE_FREQ_GHz}
# )
# CHEVRON = LabelDict({"xlabel": "Pulse duration (ns)", "ylabel": "Frequency (MHz)"})
# AMPLITUDE_TIME = LabelDict(
#     {"xlabel": "Pulse duration (ns)", "ylabel": "Frequency (MHz)"}
# )
# RAMSEY = LabelDict(
#     {
#         "label": "ramsey",
